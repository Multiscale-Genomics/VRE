...
//var_dump($_SESSION['validation']);
	...
	case 'BAM':
		...
		$baiMeta = array(
			...
			"associated_id"=> $fnPath
			);
		$baiOut=array(  "name"     => "bam_index",
				"file_path"=> "$bamFn.bai",
				"data_type"=> $_REQUEST['data_type'],
				"source_id"=> array($fn),
				"taxon_id" => $_REQUEST['taxon_id'],
		...
		//call tool
		$pid = launchToolInternal("BAMval",$toolInputs,$toolArgs,$toolOuts);
