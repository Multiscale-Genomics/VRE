...
// Check given state against previously stored one to mitigate CSRF attack
    ...
    if($user){
        ...
        if (!$resourceOwner['mug_id']){
            ...
            if (!$r)
                $_SESSION['errorData']['Error'][] = "Central authorization Server has no 'mug_id' for '".$resourceOwner['username'];
        }

        //print "EXCELENT ! GO TO ../home/redirect.php<br/>";
        redirect("../home/redirect.php");
    }else{
        //print "OOOUUPPSS ! GO TO ../home/redirect.php<br/>";
