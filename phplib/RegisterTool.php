...
class RegisterTool {
    ...
    */
    ...
    foreach ($this->tool_io['input_files_combinations'] as $comb){
        ...
        #
        #TOOL_EXECUTABLE=/usr/local/code/mg-process-macs2/process_macs2.py
        #PYTHON_LIBRARY=/home/pmes/.pyenv/versions/mg-process-macs2/lib/python2.7/site-packages/
        #
        ## Test directories
        #
        #CWD="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
        #WORKING_DIR=$CWD/run_000
        #TEST_DATA_DIR=$CWD/json/0_combination1
        #
        ...
        #
        #                time runcompss -d --summary --lang=python --base_log_dir=$WORKING_DIR --pythonpath=$PYTHON_LIBRARY $TOOL_EXECUTABLE --config $TEST_DATA_DIR/config.json --in_metadata $TEST_DATA_DIR/in_metadata.json --out_metadata $TEST_DATA_DIR/out_metadata.json > $WORKING_DIR/tool.log
        #
        #
        #
        #
    	...
    	fwrite($fout, "###\n");
    	fwrite($fout, "### * Automatically created by MuGVRE *\n");
    	fwrite($fout, "###\n");
    	fwrite($fout, "\n");
    	fwrite($fout, "\n");
