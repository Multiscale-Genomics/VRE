...
return declare(
    ...
    buildRendering: function() {
        ...
        dom.create(
            'h2',
            { className: 'title',
              innerHTML: '<div style=\"position: relative\"><br/><img src=\"http://vre.multiscalegenomics.eu/assets/layouts/layout/img/logo.png\" class=\"logo-default\"></div><br/>Available Tracks'
            },
