...
/*$command = new \MongoDB\Driver\Command([                                                                                                                                   
      User.php                 | 56                                                                                                                                                                                
      Utilities.php            | 57       'aggregate' => $collection,                                                                                                                                              
  ▸ SGE/                       | 58       'pipeline' => [                                                                                                                                                          
  ▸ validation/                | 59           ['$group' => ['_id' => null, 'sum' => ['$sum' => '$'.$field]]],                                                                                                      
    dependencies.php           | 60       ],                                                                                                                                                                       
    routes.php                 | 61       'cursor' => new \stdClass,                                                                                                                                               
    settings.git.php           | 62                                                                                                                                                                                
    settings.php               | 63     ]);     */


/*$out = $GLOBALS['filesCol']->aggregate(
				array('$group' => array('_id' => null, 'owner' => null, 'sum' => array('$sum' => '$size')))
			);
	
	var_dump($out);	*/

/*$result = $GLOBALS['filesCol']->aggregate(array(
    array(
      '$project' => array(
          'owner' => array('owner' => 'MuGUSER58e684945736f')
      ),
    ),
    array(
      '$group' => array(
          '_id' => array('owner' => '$owner'),
          'n' => array('$sum' => 1)
      ),
    )
));
