...
<body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
                ...
                <h3 class="form-title font-green">Data Base Error</h3>
                        <p>Oups! Something went wrong... try to access the platform later</p>
                        <p><?php echo $_REQUEST['msg'];?></p>
                        <!--<p>Something went wrong with the MuG VRE Data Base, please, try to access the platform later. </p>--!>

				 </div>

<div class=" copyright "> &copy; <?php echo date("Y"); ?> MuG Virtual Research Environment</div>
<!--[if lt IE 9]>
