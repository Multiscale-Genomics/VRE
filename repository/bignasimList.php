...
// http://mmb.irbbarcelona.org/bns/system.json
...
<!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"><a href="https://mmb.irbbarcelona.org/BIGNASim/browse.php" target="_blank"><img src="assets/layouts/layout/img/BigNASim_rot.png" width=100></a> BIGNASim - comprehensive database for nucleic acids simulations
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                            ...
                                            <tbody>
											  <?php
												foreach($studies as $key => $value):
													...
													$pdbs = $GLOBALS['pdbCol']->findOne(array('_id'=>strtoupper($value->PDB)),array('compound'=>1));
													$title = $pdbs["compound"];
