...
if(count($_REQUEST['fn']) > 1) {
	$_SESSION['errorData']['Error'][] = "Please, select one PDB file as input for running this tool";
	redirect('/workspace/');
}
	...
	<!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Structure Energy Refinement using Atomistic Molecular Dynamics </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
				<div class="col-md-12">
				...
				<?php } ?>
                              ...
                              <!-- END PORTLET 0: INPUTS -->
														...
														<form action="#" class="horizontal-form" id="minimizedStruct-form">
																<input type="hidden" name="tool" value="minimizedStruct" />
                              ...
                              <div class="portlet box blue form-block-header" id="form-block-header1">
                                  ...
                                  <div class="portlet-body form form-block" id="form-block1">
                                      <div class="form-body">
                                              ...
                                              <div class="col-md-6">
                                                  <div class="form-group">
                                                      <label class="control-label">Input Structure, pdb format <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Input PDB structure to be energetically refined.</p>"></i></label>
                                                      <select  name="input_files[pdb]" class="form-control form-field-enabled ">
																												<?php foreach ($inPaths as $file) {  ?>
