...
<head>
    ...
    <link href="http://vre.multiscalegenomics.eu/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link href="http://vre.multiscalegenomics.eu/assets/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
    <link href="http://vre.multiscalegenomics.eu/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="http://vre.multiscalegenomics.eu/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
	<link href="http://vre.multiscalegenomics.eu/assets/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css" />
    <link href="http://vre.multiscalegenomics.eu/assets/layouts/layout/css/themes/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color" />			
	<link href="http://vre.multiscalegenomics.eu/assets/layouts/layout/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<body>  
  ...
  <div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
      <!-- BEGIN LOGO -->
      <div class="page-logo">
        <a href="http://vre.multiscalegenomics.eu/workspace/">
          <img src="http://vre.multiscalegenomics.eu/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" />
        </a>
      </div>
      <!-- END LOGO -->
    </div>
    ...
    <div class="page">
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div id="seqlogo" class="carousel" data-ride="carousel" data-interval="">
            <div class="carousel-inner" role="listbox">
              <div class="item  active ">
                <img src="example/logo.png" alt="Twist">
              </div>
            </div>
          </div>
          ...
          <div id="logos" class="carousel helpar" data-ride="carousel" data-interval="">
            <div class="carousel-inner" role="listbox">
              ...
              <div class="item">
                <img src="example/twistL.png" alt="Twist">
              </div>
              
              <div class="item ">
                <img src="example/minwL.png" alt="MinorGroove">
              </div>
              
              <div class="item ">
                <img src="example/majwL.png" alt="MajorGroove">
              </div>
              ...
              <div class="item active ">
                <img src="example/shearL.png" alt="Shear">
              </div>
              
              <div class="item ">
                <img src="example/stretchL.png" alt="Stretch">
              </div>
              
              <div class="item ">
                <img src="example/staggerL.png" alt="Stagger">
              </div>
              
              <div class="item ">
                <img src="example/buckleL.png" alt="Buckle">
              </div>
              
              <div class="item ">
                <img src="example/propellerL.png" alt="Propeller">
              </div>
              
              <div class="item ">
                <img src="example/openingL.png" alt="Opening">
              </div>
              
              <div class="item ">
                <img src="example/shiftL.png" alt="Shift">
              </div>
              
              <div class="item ">
                <img src="example/slideL.png" alt="Slide">
              </div>
              
              <div class="item ">
                <img src="example/riseL.png" alt="Rise">
              </div>
              
              <div class="item ">
                <img src="example/tiltL.png" alt="Tilt">
              </div>
              
              <div class="item ">
                <img src="example/rollL.png" alt="Roll">
              </div>
          ...
          <div id="plots" class="carousel helpar" data-ride="carousel" data-interval="">
            <div class="carousel-inner" role="listbox">
              ...
              <div class="item ">
                <img src="example/twist.png" alt="Twist">
                <!-- <div class="carousel-caption">Twist</div> -->
              </div>
              
              <div class="item ">
                <img src="example/minw.png" alt="MinorGroove">
                <!-- <div class="carousel-caption">Width0</div> -->
              </div>
              
              <div class="item ">
                <img src="example/majw.png" alt="MajorGroove">
              ...
              <div class="item active ">
                <img src="example/shear.png" alt="Shear">
                <!-- <div class="carousel-caption">Shear</div> -->
              </div>
              
              <div class="item ">
                <img src="example/stretch.png" alt="Stretch">
                <!-- <div class="carousel-caption">Stretch</div> -->
              </div>
              
              <div class="item ">
                <img src="example/stagger.png" alt="Stagger">
                <!-- <div class="carousel-caption">Stagger</div> -->
              </div>
              
              <div class="item ">
                <img src="example/buckle.png" alt="Buckle">
                <!-- <div class="carousel-caption">Buckle</div> -->
              </div>
              
              <div class="item ">
                <img src="example/propeller.png" alt="Propeller">
                <!-- <div class="carousel-caption">Propeller</div> -->
              </div>
              
              <div class="item ">
                <img src="example/opening.png" alt="Opening">
                <!-- <div class="carousel-caption">Opening</div> -->
              </div>
              
              <div class="item ">
                <img src="example/shift.png" alt="Shift">
                <!-- <div class="carousel-caption">Shift</div> -->
              </div>
              
              <div class="item ">
                <img src="example/slide.png" alt="Slide">
                <!-- <div class="carousel-caption">Slide</div> -->
              </div>
              
              <div class="item ">
                <img src="example/rise.png" alt="Rise">
                <!-- <div class="carousel-caption">Rise</div> -->
              </div>
              
              <div class="item ">
                <img src="example/tilt.png" alt="Tilt">
                <!-- <div class="carousel-caption">Tilt</div> -->
              </div>
              
              <div class="item ">
                <img src="example/roll.png" alt="Roll">
        ...
        <div class="col-md-7">
          <!-- NGL for PDIView -->
          <!-- version 0.1 -->
          <script type="text/javascript" src="js/vendor/ngl.js"></script>
          <script type="text/javascript" src="js/representationgroup.js"></script>
          <script type="text/javascript" src="js/pdiview.js"></script>
          <script type="text/javascript">
            $(document).ready(function() {
                ngl_viewer("example/output_X.pdb",
                           "example/output_B.pdb",
                           "example/output_R.pdb",
                           "example/output.pdb",
                           "example/pairings.dat",
                           "example/interactions.dat",
                           "example/sequence.dat");
            });
          </script>
