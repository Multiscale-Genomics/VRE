...
if (!isset($_REQUEST['fn']) && !isset($_REQUEST['rerunDir'])){
	$_SESSION['errorData']['Error'][]="Please, before running MC DNA, select a TXT file with a DNA sequence as input.";
	redirect('/workspace/');
}

if(count($_REQUEST['fn']) > 1) {
	$_SESSION['errorData']['Error'][] = "Please, select one TXT file with a DNA sequence as input for running this tool";
	redirect('/workspace/');
}
	...
	<!-- BEGIN CONTENT -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                              ...
                              <li>
                                  <span>MC-DNA Dynamics</span>
                              </li>
                            </ul>
                        </div>
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> MC-DNA Dynamics </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
				<div class="col-md-12">
				...
				<?php } ?>
                              ...
                              <!-- END PORTLET 0: INPUTS -->
														...
														<form action="#" class="horizontal-form" id="dnadyn-form">
																<input type="hidden" name="tool" value="dnadyn" />
                              ...
                              <div class="portlet box blue form-block-header" id="form-block-header1">
                                  ...
                                  <div class="portlet-body form form-block" id="form-block1">
                                      <div class="form-body">
                                              ...
                                              <div class="col-md-6">
                                                  <div class="form-group">
                                                      <label class="control-label">DNA Sequence <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Select DNA sequence as input.</p>"></i></label>
                                                      <select  name="input_files[sequence]" class="form-control form-field-enabled ">
																												<?php foreach ($inPaths as $file) {  ?>
                                              ...
                                              <div class="col-md-6">
                                                      ...
                                                      <label class="control-label">Operations <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Number of structures to generate (max 500).</p>"></i></label>
                                                      <select class="form-control form-field-enabled valid select2dnadyn" name="arguments[operations][]" id="operations" aria-invalid="false" multiple="multiple">
                                                          <option value=""></option>
                                                      ...
                                                      <label class="control-label">Number of structures <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Help for Number of structures.</p>"></i></label>
																											<input type="number" name="arguments[createTrajectory:numStruct]" id="numStruct" class="form-control" min="1" max="500" value="100" disabled>
                                                  </div>
																							</div>
