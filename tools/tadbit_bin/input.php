                                          ...
                                          <div class="row">
                                              <div class="col-md-6">
                                                      ...
                                                      <label class="control-label">Resolution <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Resolution of the binning (should input a number between 10000 (10 kb) and 10000000 (10 Mb)).</p>"></i></label>
																							...
																							<div class="col-md-6">
																									<div class="form-group">
                                                      <label class="control-label">Coordinate of the region to retrieve <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Coordinate of the region to retrieve. By default all genome, arguments can be either one chromosome name, or the coordinate in the form: chr3 or chr3:110000000-120000000.</p>"></i></label>
