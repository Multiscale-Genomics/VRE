...
if((count($_REQUEST['fn']) <  2)){
	$_SESSION['errorData']['Error'][] = "Please, select one FASTA files, and one or two FASTQ";
	redirect('/workspace/');
}
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-container-bg-solid page-sidebar-fixed">
  ...
  <?php require "../../htmlib/menu.inc.php"; ?>
	...
	<!-- BEGIN CONTENT -->
			 ...
			 <form action="#" class="horizontal-form" id="process-rnaseq">
                                      ...
                                      <div class="form-body">
                                          <h4 class="form-section">File inputs</h4>
                                            <div class="row">
                                                ...
                                                <select  name="input_files[<?php echo $tool['input_files']['fastq2']['name']?>]" class="form-control form-field-enabled params_rnaseq_inputs">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <select  name="input_files[<?php echo $tool['input_files']['fastq1']['name']?>]" class="form-control form-field-enabled params_rnaseq_inputs">
																								<option selected="" value=""> -- select a file -- </option>
 																								<?php foreach ($inPaths as $file) {  ?>
																									<?php if($file['format'] == 'FASTQ') { ?>
																									<?php $p = explode("/", $file['path']); ?>
