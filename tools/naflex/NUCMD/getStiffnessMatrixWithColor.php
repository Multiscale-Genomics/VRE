...
print '<div>';
    ...
    <p style='text-align:center;'><b>Units:<br/> </b><i>Diagonal Shift/Slide/Rise in kcal/(mol*&Aring;&sup2;), Diagonal Tilt/Roll/Twist in kcal/(mol*degree&sup2;)<br/>
                        ...
                        <a href="http://mmb.irbbarcelona.org/NAFlex2/getFile.php?fileloc=<?php echo $f_location ?>&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>
                        </td><!--<td>
...
function generateStiffnessTable ($tableFile) {
	...
	$code .="<tr align='center' style='background-color:#dcdcdc'><td style='background-color:#fafafa'></td><td style='background-color:#dcdcdc'>Shift</td><td style='background-color:#dcdcdc'>Slide</td><td style='background-color:#dcdcdc'>Rise</td><td style='background-color:#dcdcdc'>Tilt</td><td style='background-color:#dcdcdc'>Roll</td><td style='background-color:#dcdcdc'>Twist</td></tr>\n";
