...
#$GLOBALS['homeNUCMD_FULL'] = "http://mmb.irbbarcelona.org/BigNASim";
#$GLOBALS['homeNUCMD_FULL'] = $_SERVER['PHP_SELF'];
$GLOBALS['homeNUCMD_FULL'] = ".";
$GLOBALS['homeNUCMD'] = ".";
$GLOBALS['listAnalysis'] = array('CURVES','STIFFNESS','STACKING_avg','HBs_avg','NMR_NOE_avg','NMR_JC_avg');
$GLOBALS['parmbsc1Dir'] ="../NAFlex2/NAFlex-Data/NAFlex_parmBSC1";
$GLOBALS['scriptsDir'] ="../NAFlex2/NAFlex-Data/NA_Analysis/scripts";
