...
?>
	...
	<div id="Avg_Params">
		...
		<td id="Rib_Avg_images" rowspan="20">
                <img id="Rib_Avg" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_trans.png" width="300" align="center" class="unhidden">
                <img id="J1p2pSel_AvgRib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p2p_trans.png" width="300" align="center" class="hidden">
                <img id="J2p3pSel_AvgRib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J2p3p_trans.png" width="300" align="center" class="hidden">
                <img id="J3p4pSel_AvgRib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J3p4p_trans.png" width="300" align="center" class="hidden">
	...
	<div id="Time_Params">
		...
		<td id="Rib_images" rowspan="20">
                <img id="Rib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_trans.png" width="300" align="center" class="unhidden">
                <img id="J1p2p-RNASelRib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p2p_trans.png" width="300" align="center" class="hidden">
                <img id="J2p3p-RNASelRib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J2p3p_trans.png" width="300" align="center" class="hidden">
                <img id="J3p4p-RNASelRib" src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J3p4p_trans.png" width="300" align="center" class="hidden">
		<p><i style="font-size:12pt">RNA Ribose</i></p>
		</td></tr>
		</table>
        </div>
	...
	<!-- PLOTS -->
        ...
        <div id="HelicalParamsPlots">
                ...
                <div id="J1p2p-RNAAvgSelPlot" class="hidden" style="text-align:left; padding: 15px 40px;">
			<?php plotAVG ($userPath,"J1p2p-RNA_avg"); ?>
                </div>
                <div id="J2p3p-RNAAvgSelPlot" class="hidden" style="text-align:left; padding: 15px 40px;">
			<?php plotAVG ($userPath,"J2p3p-RNA_avg"); ?>
                </div>
                <div id="J3p4p-RNAAvgSelPlot" class="hidden" style="text-align:left; padding: 15px 40px;">
...
<?php
	...
	?>
        ...
        <div id="J1p2p-RNATimeSelPlot" class="hidden" style="text-align:left; padding: 15px 40px;"></div>
        <div id="J2p3p-RNATimeSelPlot" class="hidden" style="text-align:left; padding: 15px 40px;"></div>
        <div id="J3p4p-RNATimeSelPlot" class="hidden" style="text-align:left; padding: 15px 40px;"></div>
        </div>
