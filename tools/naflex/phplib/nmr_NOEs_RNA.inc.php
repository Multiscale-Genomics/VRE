...
?>
	...
	<input type="hidden" name="path" value="<?php echo $path ?>" />
		...
		<td id="Rib_Avg_images" rowspan="6" align="center">
                <p id="Rib_Avg" class="unhidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J1p2pSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J1p2p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p2p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J2p3pSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J2p3p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J2p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J2p4pSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J2p4p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J2p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J3p4pSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J3p4p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J3p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J1p3pSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J1p3p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J1p4pSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J1p4p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="J1p68Sel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_1p68_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_1p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Pyrimidine (segment)</i></p>
                <p id="J2p68Sel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_2p68_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_2p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Pyrimidine (segment)</i></p>
                <p id="J3p68Sel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_3p68_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_3p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Pyrimidine (segment)</i></p>
                <p id="J4p68Sel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_4p68_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_4p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Purine (segment)</i></p>
                <p id="J56Sel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_56_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_56_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Pyrimidine (segment)</i></p>
                <p id="J1p68-StepSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_1p68_Step_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_1p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Pyrimidine-Purine Step (Segment)</i></p>
                <p id="J2p68-StepSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_2p68_Step_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_2p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Pyrimidine-Purine Step (Segment)</i></p>
                <p id="J3p68-StepSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_3p68_Step_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_3p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Pyrimidine-Purine Step (Segment)</i></p>
                <p id="J4p68-StepSel_AvgRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/R_4p68_Step_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/R_4p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Pyrimidine-Purine Step (Segment)</i></p>
	...
	<div id="Time_Params">
		...
		<td id="Rib_images" rowspan="6" align="center">
                <p id="Rib" class="unhidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="Nuc_H1p-Nuc_H2pSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J1p2p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p2p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="Nuc_H1p-Nuc_H3pSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J1p3p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="Nuc_H1p-Nuc_H4pSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J1p4p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J1p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="U_Nuc_H1p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RU_1p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RU_1p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Uracil</i></p>
                <p id="U_Nuc_H2p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RU_2p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RU_2p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Uracil</i></p>
                <p id="U_Nuc_H3p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RU_3p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RU_3p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Uracil</i></p>
                <p id="U_Nuc_H4p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RU_4p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RU_4p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Uracil</i></p>
                <p id="U_Nuc_H5-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RU_56_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RU_56_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Uracil</i></p>
                <p id="C_Nuc_H1p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RC_1p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RC_1p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Cytosine</i></p>
                <p id="C_Nuc_H2p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RC_2p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RC_2p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Cytosine</i></p>
                <p id="C_Nuc_H3p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RC_3p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RC_3p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Cytosine</i></p>
                <p id="C_Nuc_H4p-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RC_4p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RC_4p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Cytosine</i></p>
                <p id="C_Nuc_H5-Nuc_H6SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RC_56_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RC_56_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Cytosine</i></p>
                <p id="G_Nuc_H1p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RG_1p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RG_1p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Guanine</i></p>
                <p id="G_Nuc_H2p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RG_2p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RG_2p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Guanine</i></p>
                <p id="G_Nuc_H3p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RG_3p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RG_3p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Guanine</i></p>
                <p id="G_Nuc_H4p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RG_4p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RG_4p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Guanine</i></p>
                <p id="A_Nuc_H1p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RA_1p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RA_1p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Adenine</i></p>
                <p id="A_Nuc_H2p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RA_2p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RA_2p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Adenine</i></p>
                <p id="A_Nuc_H3p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RA_3p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RA_3p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Adenine</i></p>
                <p id="A_Nuc_H4p-Nuc_H8SelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RA_4p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RA_4p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Adenine</i></p>
                <p id="Nuc_H2p-Nuc_H3pSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J2p3p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J2p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="Nuc_H2p-Nuc_H4pSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J2p4p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J2p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="Nuc_H3p-Nuc_H4pSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/ribose_J3p4p_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/ribose_J3p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>RNA Ribose</i></p>
                <p id="Nuc_H1p-Nuc_H6-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPurines_Pyrimidines_1p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPurines_Pyrimidines_1p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H2p-Nuc_H6-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPurines_Pyrimidines_2p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPurines_Pyrimidines_2p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H3p-Nuc_H6-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPurines_Pyrimidines_3p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPurines_Pyrimidines_3p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H4p-Nuc_H6-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPurines_Pyrimidines_4p6_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPurines_Pyrimidines_4p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H1p-Nuc_H8-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPyrimidines_Purines_1p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPyrimidines_Purines_1p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H2p-Nuc_H8-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPyrimidines_Purines_2p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPyrimidines_Purines_2p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H3p-Nuc_H8-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPyrimidines_Purines_3p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPyrimidines_Purines_3p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
                <p id="Nuc_H4p-Nuc_H8-StepSelRib" class="hidden"><a href="javascript:openIMG('<?php echo $GLOBALS['BASEURL'].'tools/naflex'; ?>/images/RPyrimidines_Purines_4p8_trans.png');" target="_blank"><img src="<?php echo $GLOBALS['BASEURL'].'tools/naflex/'; ?>images/RPyrimidines_Purines_4p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/>Purines-Pyrimidines (Segment)</i></p>
		</td></tr>
		</table>
        </div>
        </div>
...
<?php
	...
	?>
		...
		<a href="<?php echo $GLOBALS['BASEURL']; ?>tools/naflex/getFile.php?fileloc=<?php echo $userPath."/NOE.stats" ?>&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>
		</td></tr></table>
	</div>
	</div>
	</div>
