...
if((count($_REQUEST['fn']) <  2)){
	$_SESSION['errorData']['Error'][] = "Please, select two FASTQ files and one FASTQ";
	redirect('/workspace/');
}
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-container-bg-solid page-sidebar-fixed">
  ...
  <?php require "../../htmlib/menu.inc.php"; ?>
	...
	<!-- BEGIN CONTENT -->
			 ...
			 <form action="#" class="horizontal-form" id="process-wgbs">
...
<!--
				<h4 class="form-section">Settings</h4>
                                          <div class="row">
                                              <div class="col-md-6">
																									<div class="form-group">
                                                      <label class="control-label"><?php echo $tool['arguments']['aligner']['description']?> <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'><?php echo $tool['arguments']['aligner']['help']?></p>"></i></label>
																											<input type="text" name="arguments[<?php echo $tool['arguments']['aligner']['name']?>]" id="<?php echo $tool['arguments']['aligner']['name']?>" class="form-control" value="bowtie2">
                                                  </div>
																							</div>
																							<div class="col-md-6">
																									<div class="form-group">
                                                      <label class="control-label"><?php echo $tool['arguments']['aligner_path']['description']?> <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'><?php echo $tool['arguments']['aligner_path']['help']?></p>"></i></label>
																											<input type="text" name="arguments[<?php echo $tool['arguments']['aligner_path']['name']?>]" id="<?php echo $tool['arguments']['aligner_path']['name']?>" class="form-control" value="${HOME}/lib/bowtie2-2.3.2">
                                                  </div>
																							</div>
																					</div>
																					<div class="row">
