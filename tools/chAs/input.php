...
if((count($_REQUEST['fn']) != 1)){
	$_SESSION['errorData']['Error'][] = "Please, select one file of format FASTA for running this tool";
	redirect('/workspace/');
}
...
// get tool details. TITLE, NAME, HELP and DESCRIPTION can be extracted from here
$toolId = "process_genome";
                                  ...
                                  <div class="portlet-body form form-block" id="form-block1">
                                      <div class="form-body">
                                          <h4 class="form-section">File inputs</h4>
                                            <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <select  name="input_files[<?php echo $tool['input_files']['genome']['name']?>]" class="form-control form-field-enabled params_pydock_inputs">
 													<?php foreach ($inPaths as $file) {  ?>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-6">
												  <div class="form-group">
                                                  <label class="control-label"><?php echo $tool['arguments']['exemple1']['description']?> <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'><?php echo $tool['arguments']['exemple1']['help']?></p>"></i></label>
                                                  <select class="form-control form-field-enabled valid" name="arguments[<?php echo $tool['arguments']['exemple1']['name']?>]" aria-invalid="false">
                                              ...
                                              <div class="col-md-6">
												<div class="form-group">
                                                <label class="control-label"><?php echo $tool['arguments']['exemple2']['description']?> <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'><?php echo $tool['arguments']['exemple2']['help']?></p>"></i></label>
                                                <select class="form-control form-field-enabled valid" name="arguments[<?php echo $tool['arguments']['exemple2']['name']?>]" aria-invalid="false">
                                                        <option value="" selected=""></option>
                                                    </select>
                                                </div>
                                              </div>
