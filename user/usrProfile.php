...
<?php
				...
				<?php } ?>
											<p>These are your user credentials required for authenticating to any of the MuG data repositories. VRE manage them on your behalf for accessing to your data.</p>
											<div class="form-group mt-clipboard-container">
                                               <label class="control-label">Access Token <i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Bearer token used to authenticate your access to any MuG data repository.</p>"></i></label>
...
<i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Bearer token used to authenticate your access to any MuG data repository.</p>"></i></label>
    </td>
    <td>
    <textarea style="width:100%;word-wrap:break-word;"><?php echo $_SESSION['User']['Token']['access_token']; ?></textarea>
    </td>
</tr>
<tr>
    <td>
		<label class="control-label">Expiration date
<i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Access token expiration time. Its lifespan is short, so VRE refreshs it just before accessing the requested resource, if needed.</p>"></i></label>
    </td>
    <td>
    <?php echo date('h:i:s A (jS \of F Y)',$_SESSION['User']['Token']['expires']);?>
    <br/>
                                                        <?php
                                                            $expiresIn = $_SESSION['User']['Token']['expires']-time();
                                                            if ($expiresIn > 0 )
                                                                echo "<i>Token will expire in ". intval($expiresIn/60) ." minutes</i>";
                                                            else
                                                                echo "<i>This Token is expired...  It needs a refresh!</i>";
                                                        ?>
...
<i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Token used to refresh an expired access token. It is revoked when used, so access tokens are issued together with a new refresh token</p>"></i></label>
    </td>
    <td>
    <textarea style="width:100%;word-wrap:break-word;"><?php echo $_SESSION['User']['Token']['refresh_token']; ?></textarea>
    </td>
</tr>
<tr>
    <td>
		<label class="control-label">Expiration date
<i class="icon-question tooltips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Access token expiration time. A new SSO session is required to obtain a new pair of tokens.</p>"></i></label>
    </td>
    <td>
                                                        <?php
                                                            $expiresDate = $_SESSION['User']['Token']['expires'] + $_SESSION['User']['Token']['refresh_expires_in'];
                                                        ?>
     <?php echo date('h:i:s A (jS \of F Y)',$expiresDate); ?>
     <br/>
                                                        <?php
                                                            $expiresIn   = $expiresDate-time();
                                                            if ($expiresIn > 0 )
                                                                ...
                                                                echo "<i>This Token is expired...  It needs a new login!</i>";
                                                            if ($expiresIn > 0 )
                                                        ?>
    </td>
</tr>
