...
/*if ($_SESSION['User']['Type'] == 0){
	$result = $GLOBALS['toolsDevCol']->find(array());
}else{
        if ($_SESSION['User']['ToolsDev']){
            $result = $GLOBALS['toolsDevCol']->find(array("_id" => array('$in' => $_SESSION['User']['ToolsDev'])));
        }else{
...
/*}else{
	$_SESSION['errorData']['Error'][]="You have no tool ownership associated. Please, contact <a href=\"mailto:".$GLOBALS['helpdeskMail']."\">us</a>";
	// force empty list 
	$result = $GLOBALS['toolsDevMetaCol']->find(array("_id" => ""));
	}*/
//*************************************
                                        ...
                                        <table class="table table-striped table-bordered" id="my-new-tools" style="margin-top:30px;">
                                            <thead>
                                                <tr>
													...
													<th rowspan="2" style="vertical-align:middle">Define MuGVRE Tool
                                                    ...
                                                    <th style="border-right: 1px solid #e7ecf1;">Bring us your code
													<a href="javascript:;" target="_blank" class="tooltips" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Click the icon to open 'Bring your tool - Step 2' in a new tab"><i class="icon-question"></i></a>
                                                    </th>
                                                </tr>
			...
			<tr>
                ...
                <td style="padding-top:30px;">
                    ...
                    <br/><br/>
										...
										<br><br>
										<?php if(file_exists(__DIR__ . "/../files/".$v["user_id"]."/.dev/".$v["_id"]."/logo/logo.png")) { ?>
					...
					<?php if(!$v["step1"]["tool_io_files"]) { ?>
                     ...
                     <?php } else { ?>
                      ...
                      <!-- show step1 test files | OLD -->
                        <!--
						<?php //foreach($v["step1"]["tool_io"]["input_files_combinations"] as $option) { ?>
						<div class="clearfix margin-bottom-10">
							<p style="margin-bottom:0;"><?php //echo $option["description"]; ?>:</p>
							<div class="btn-group btn-group-circle" style="margin-top:5px;">
									<button class="btn green btn-block btn-sm dropdown-toggle" type="button" data-toggle="dropdown"> test
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li>
												<a href="javascript:;" target="_blank"><i class="fa fa-external-link"></i> Visualize </a>
										</li>
                                    </ul>
							</div>
							<div class="btn-group" style="margin-top:5px;">
									<button class="btn green btn-block btn-sm dropdown-toggle" type="button" data-toggle="dropdown"> config
											<i class="fa fa-angle-down"></i>
									</button>
									<ul class="dropdown-menu" role="menu">
										<li>
							...
							<div class="btn-group" style="margin-top:5px;">
                                    <button class="btn green btn-outline dropdown-toggle" type="button" data-toggle="dropdown"> in_metadata
											<i class="fa fa-angle-down"></i>
									</button>
									<ul class="dropdown-menu" role="menu">
										<li>
                ...
                <!-- show final step status -->
					<?php switch($v['last_status']) { 
                        ...
                        case "registered":  ?>
                            ...
                            <p class="font-white"><b>ACCEPTED</b>:<br/>MuGVRE tool successfully registed!</p>
                            </div>
                            <?php break;
