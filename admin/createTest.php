													...
													<div class="portlet box blue-oleo">
															...
															<div class="portlet-body form">
																...
																<div class="form-body">
																		...
																		<p>You are to develop your tool code offline, in a local environmet (i.e VM). And to best way to check that your tool is going to be properly called by MuGVRE server when integrated into the MuG cloud, is precisely emulating a MuGVRE execution to you tool code. Fill in this form with the test input files that you have in your development environent, and use the resulting JSON files to create your test script</p>
